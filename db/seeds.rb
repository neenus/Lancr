...
sp1 = ServiceProvider.create(
  ...
  pic: Rails.root.join('/vagrant/projects/lancr/public/uploads/boy.jpg').open,
...
sp2 = ServiceProvider.create(
  ...
  password_digest: BCrypt::Password.create('asdf'),
  pic: Rails.root.join('/vagrant/projects/lancr/public/uploads/girl.jpg').open,
...
sp3 = ServiceProvider.create(
  ...
  email: Faker::Internet.free_email,
  password_digest: BCrypt::Password.create('asdf'),
  pic: Rails.root.join('/vagrant/projects/lancr/public/uploads/girl2.jpg').open,
...
service0 = Service.create(
  ...
  img: Rails.root.join('/vagrant/projects/lancr/public/uploads/accounting-service.jpg').open,
  is_booked: false
)
